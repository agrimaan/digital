  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      ...
      try {
        ...
        .filter((buyerId): buyerId is string => typeof buyerId === 'string' && buyerId !== '')
        .map((buyerId: string) => {
        ...
        .filter((sellerId): sellerId is string => typeof sellerId === 'string' && sellerId !== '')
        .map((sellerId: string) => {
        ...
        setSellers(uniqueSellers);        setLoading(false);
      } catch (err: any) {
