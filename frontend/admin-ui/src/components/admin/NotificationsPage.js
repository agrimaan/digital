...
import { fetchNotifications, markNotificationAsRead, deleteNotification, sendNotification } from '../../store/actions/notificationActions';
...
const NotificationsPage = () => {
  ...
  const handleSendNotification = () => {
    dispatch(sendNotification(notificationForm));
    setOpenDialog(false);
    setNotificationForm({
      title: '',
      message: '',
